...
script = <<-SHELL
     ...
     # we only generate the key on one of the nodes
      ...
      echo ". /opt/intel/composer_xe_2015.2.164/bin/ifortvars.sh intel64" >> /home/vagrant/.bashrc
...
#  config.vm.box = "ubuntu/xenial64"
  ...
  config.vm.synced_folder "./nfs", "/vagrant", type: "nfs", mount_options: ['rw', 'vers=3', 'tcp', 'fsc', 'actimeo=1']
  ...
  config.vm.provision :ansible do |ans|
      ...
      ans.extra_vars = { n_comp_nodes: N_COMP_NODES}
